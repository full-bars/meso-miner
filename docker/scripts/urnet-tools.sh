...
do_update() {
    ...
    if [ -n "$requested_tag" ]; then
        release_url="https://api.github.com/repos/full-bars/meso-miner/releases/tags/$requested_tag"
    else
        release_url="https://api.github.com/repos/full-bars/meso-miner/releases/latest"
    fi
