...
- feat(pelican): Pelican panel egg with PELICAN-gated runtime updates by @full-bars in https://github.com/full-bars/meso-miner/pull/21
- fix(urnet-tools): harden update verification — PID tracking, ramlog check, trap cleanup by @full-bars in https://github.com/full-bars/meso-miner/pull/23
- fix(provider): cap slow-retry at 14 days, drop dead proxies from active pool by @full-bars in https://github.com/full-bars/meso-miner/pull/24
- v30.8: release notes, docs updates, Pelican egg proxy support by @full-bars in https://github.com/full-bars/meso-miner/pull/25
- fix(provider): corrupt-state bug — return fresh state on Unmarshal failure by @full-bars in https://github.com/full-bars/meso-miner/pull/26
- docs: fix wrong env var defaults, eviction threshold by @full-bars in https://github.com/full-bars/meso-miner/pull/27
- fix(docker): self-update must fetch THIS fork's releases, with digest verification by @full-bars in https://github.com/full-bars/meso-miner/pull/28
- fix(provider): parity — timer leak fix, log wording, drop-clock comment by @full-bars in https://github.com/full-bars/meso-miner/pull/29
- fix(docker): urnet-tools function names must match update_verify.sh exports by @full-bars in https://github.com/full-bars/meso-miner/pull/30
